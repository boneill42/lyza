...
import com.griddelta.lyza.exception.LyzaException;
import com.griddelta.lyza.resource.JsonMarshaller;
...
public class CassandraStorage {
	...
	public JSONArray getKeyspaces() throws LyzaException,
	...
	public void addKeyspace(String keyspace, String strategy,
			int replicationFactor) throws LyzaException {
	...
	public void dropTable(String keyspace, String table) throws LyzaException {
		String statement = String.format("drop table %s;", table);
		executeStatement(keyspace, statement);
	}

	public void dropKeyspace(String keyspace) throws LyzaException {
	...
	public void createTable(String keyspace, String columnFamilyName,
			JSONObject columns, JSONArray keys) throws LyzaException {
		if (columns == null || keys == null)
			throw new LyzaException(
	...
	public void update(String keyspace, String table, JSONObject row,
			...
			throws LyzaException, IOException {
	...
	public JSONArray select(String keyspace, String table, JSONArray columns,
			...
			throws LyzaException, CharacterCodingException {
	...
	private ResultSet executeStatement(String keyspace, Statement statement) {
		if (LOG.isDebugEnabled())
			LOG.debug("On [" + keyspace + "], executing [" + statement + "] ");
